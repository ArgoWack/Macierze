...
namespace Program_Główny_I_J
{
    ...
    class Single_matrix_operations
    {
        ...
        {
            double[,] table3 = new double[Rows1, Columns1];
            int choice_number1 = Exceptions_handling.Exceptions_int(0, 1,
            ...
            if (choice_number1 == 0)
            {
                ...
                switch (choice_number2)
                {
                    case 1:
                    {
                        int column_number = Exceptions_handling.Exceptions_int(0, Columns1, "wybierz kolumnę");
                    ...
                    case 0:
                    {
                        int column1 = Exceptions_handling.Exceptions_int(0, Columns1,
                            "wybierz kolumnę do której będziesz dawał/odejmował inną kolumnę");
                        double scalar1 =
                            Exceptions_handling.Exceptions_double_without_limits(
                                "Podaj skalar przez który mnożysz podaną kolumnę");
                        int choice_number3 = Exceptions_handling.Exceptions_int(0, 1,
                            "Wybiersz operację: dodawanie - 0 \n odejmowanie - 1 \n");
                        int column2 = Exceptions_handling.Exceptions_int(0, Columns1,
                    ...
                    {
                        int column =
                            Exceptions_handling.Exceptions_int(0, Columns1, "wybierz kolumnę którą chcesz usunąć");
            ...
            else if (choice_number1 == 1)
            {
                ...
                switch (choice_number2)
                {
                    case 1:
                    {
                        int row = Exceptions_handling.Exceptions_int(0, Rows1, "wybierz wiersz");
                        double scalar = Exceptions_handling.Exceptions_double_without_limits("Podaj skalar");
                    ...
                    case 0:
                    {
                        int row1 = Exceptions_handling.Exceptions_int(0, Rows1,
                        ...
                        int choice_number3 = Exceptions_handling.Exceptions_int(0, 1,
                            "Wybiersz operację: dodawanie - 0 \n odejmowanie - 1 \n");
                        int row2 = Exceptions_handling.Exceptions_int(0, Rows1,
                    ...
                    case 2:
                    {
                        int row = Exceptions_handling.Exceptions_int(0, Rows1, "wybierz wiersz który chcesz usunąć");
